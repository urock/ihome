...
/* Ethernet pins configuration ************************************************/
   /*
        ETH_MDIO -------------------------> PA2  --my +
        ETH_MDC --------------------------> PC1  --my +
        ETH_MII_RX_CLK/ETH_RMII_REF_CLK---> PA1  --my +
        ETH_MII_RX_DV/ETH_RMII_CRS_DV ----> PA7  --my +
        ETH_MII_RXD0/ETH_RMII_RXD0 -------> PC4  --my +
        ETH_MII_RXD1/ETH_RMII_RXD1 -------> PC5  --my +
        ETH_MII_RX_ERR              ----->  PB10  --my pb10 Обязательно нужен
        ETH_MII_TX_EN/ETH_RMII_TX_EN -----> PB11  --my pb11
        ETH_MII_TXD0/ETH_RMII_TXD0 -------> PB13  --my pb12
        ETH_MII_TXD1/ETH_RMII_TXD1 -------> PB14  --my pb13
                                                  */
