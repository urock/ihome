...
#define MAX_CMDSTR      150 //Максимальная длина команды в sendText_t
...
#define IPHost_ADDR0   192
#define IPHost_ADDR1   168
#define IPHost_ADDR2   0
#define IPHost_ADDR3   111
